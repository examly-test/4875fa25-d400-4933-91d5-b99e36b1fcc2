...
(async () => {
  ...
  await page.goto('https://8080-aacdadadbfeaaadeccfdfecdcaceefaffcabd.ide.exam.ly');
  ...
  await page1.goto('https://8081-aacdadadbfeaaadeccfdfecdcaceefaffcabd.ide.exam.ly');
